...
Merge cats to create powerful alchemical creatures

<!-- MG-GAME-SHOWCASE:START -->
## Gameplay Showcase

![Cat Alchemy Workshop gameplay screen](docs/images/gameplay-showcase.png)

**Cat Alchemy Workshop** centers on the **Upgrade and Grow** loop. The player enters from the main menu, reads the active objective and pressure state, performs the core action, banks rewards, then returns through roadmap and retention goals.
...
git clone --recursive https://github.com/monthly-games/mg-game-0002.git
