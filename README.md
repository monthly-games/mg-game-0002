...
이 프로젝트는 **고양이 연금술 공방**의 Flutter 구현체입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/design/gdd_game_0002.json](docs/design/gdd_game_0002.json) | 게임 디자인 문서 |
...
**HUD 파일**: [game/lib/ui/hud/mg_alchemy_shop_hud.dart](game/lib/ui/hud/mg_alchemy_shop_hud.dart)

### 주요 HUD 요소

| 요소 | 설명 | 컴포넌트 |
|------|------|----------|
| **골드** | 현재 보유 골드 | MGResourceBar |
| **젬** | 프리미엄 화폐 | MGResourceBar |
| **생산 진행도** | 자동 생산 진행률 | MGLinearProgress |
