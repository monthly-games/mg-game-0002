/// 배틀패스 시스템 어댑터 - MG-0002 Cat Alchemy Workshop
library;
...
/// Cat Alchemy Workshop 배틀패스
class AlchemyBattlePass extends ChangeNotifier {
  ...
  Map<String, MissionProgress> get missionProgress =>
      _manager.state?.missionProgress ?? {};
